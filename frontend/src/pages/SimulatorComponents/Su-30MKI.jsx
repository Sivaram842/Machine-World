        ...
        <div>
            ...
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:items-end">
                    ...
                    <div className="text-[13px] sm:text-[14px] leading-relaxed text-gray-300 max-w-[420px]">
                        The Sukhoi Su-30MKI is a twin-engine, two-seat multirole fighter designed
                        for air superiority and strike missions, equipped with thrust-vectoring
                        engines, advanced avionics, and long-range combat capability.
                    </div>
            ...
            >
                ...
                <div className="max-w-[1700px] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 auto-rows-[220px] sm:auto-rows-[240px] lg:auto-rows-[260px] gap-6">
                    ...
                    >
                        ...
                        <div className="absolute bottom-6 sm:bottom-8 lg:bottom-10 left-6 sm:left-8 lg:left-10 max-w-[420px]">
                            ...
                            <p className="text-gray-300 text-sm hidden sm:block">
                                The integration of the BrahMos supersonic cruise missile with the
                                Su-30MKI represents one of the most advanced air-launched strike
                                capabilities developed in India.
                            </p>
                        </div>
                    ...
                    {/* SMALL CARD */}
                    <div
                        onClick={() => navigate("su30-case-study-2")}
                        className="relative col-span-1 lg:col-span-3 rounded-xl overflow-hidden group cursor-pointer"
                        style={{ backgroundImage: `url(${Mig29K2})`, backgroundSize: "cover", backgroundPosition: "center" }}
                    >
                    ...
                    {/* SMALL CARD */}
                    <div
                        onClick={() => navigate("su30-case-study-3")}
                        className="relative col-span-1 lg:col-span-3 rounded-xl overflow-hidden group cursor-pointer"
                        style={{ backgroundImage: `url(${Mig29K3})`, backgroundSize: "cover", backgroundPosition: "center" }}
                    >
                    ...
                    {/* WIDE CARD */}
                    <div
                        onClick={() => navigate("su30-case-study-4")}
                        className="relative col-span-1 sm:col-span-2 lg:col-span-6 rounded-xl overflow-hidden group cursor-pointer"
                        style={{ backgroundImage: `url(${Mig29K4})`, backgroundSize: "cover", backgroundPosition: "center" }}
                    >
                    ...
                    {/* SMALL */}
                    <div
                        onClick={() => navigate("su30-case-study-5")}
                        className="relative col-span-1 lg:col-span-3 rounded-xl overflow-hidden group cursor-pointer"
                        style={{ backgroundImage: `url(${Mig29K5})`, backgroundSize: "cover", backgroundPosition: "center" }}
                    >
                    ...
                    {/* MEDIUM */}
                    <div
                        onClick={() => navigate("su30-case-study-6")}
                        className="relative col-span-1 lg:col-span-3 rounded-xl overflow-hidden group cursor-pointer"
                        style={{ backgroundImage: `url(${Mig29K6})`, backgroundSize: "cover", backgroundPosition: "center" }}
                    >
                    ...
                    {/* WIDE CARD */}
                    <div
                        onClick={() => navigate("su30-case-study-7")}
                        className="relative col-span-1 sm:col-span-2 lg:col-span-6 rounded-xl overflow-hidden group cursor-pointer"
                        style={{ backgroundImage: `url(${Mig29K7})`, backgroundSize: "cover", backgroundPosition: "center" }}
                    >
