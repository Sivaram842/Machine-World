      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:items-end">
          ...
          <div className="text-[13px] sm:text-[14px] leading-relaxed text-gray-300 max-w-[420px]">
            The Mikoyan MiG-29 is a twin-engine supersonic fighter jet designed
            for air superiority, known for its high maneuverability, powerful
            radar systems, and advanced combat capabilities.
          </div>
      ...
      >
        <div className="max-w-[1700px] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 auto-rows-[220px] sm:auto-rows-[240px] lg:auto-rows-[260px] gap-6">
          ...
          <div
            onClick={() =>
              window.open(
                "https://simpleflying.com/mig-29-fulcrum-complete-guide/",
              )
            }
          ...
          >
            ...
            <div className="absolute bottom-6 left-6 right-6">
              <h4 className="text-lg font-semibold">MiG-29 in the Gulf War</h4>
            </div>
          </div>
          ...
          <div
            onClick={() =>
              window.open(
                "https://www.sps-aviation.com/story/?h=Upgraded-IAF-MiG-29s-SPAR-with-Omani-F-16s&id=2670&utm_source=chatgpt.com",
              )
            }
            className="relative col-span-1 lg:col-span-3 rounded-xl overflow-hidden group cursor-pointer"
            style={{
          ...
          <div
            onClick={() =>
              window.open(
                "https://www.indiandefensenews.in/2026/01/navys-mig-29k-completes-nasm-mr.html?utm_source=chatgpt.com#google_vignette",
              )
            }
          ...
          <div
            onClick={() =>
              window.open(
                "https://aerospaceglobalnews.com/news/india-mig-29-upgrade-precision-strike/?utm_source=chatgpt.com",
              )
            }
            className="relative col-span-1 lg:col-span-3 rounded-xl overflow-hidden group cursor-pointer"
            style={{
          ...
          <div
            onClick={() =>
              window.open(
                "https://www.defensemagazine.com/article/fulcrum-the-mighty-light-frontline-fighter-from-the-mig-29-to-the-mig-35",
              )
            }
            className="relative col-span-1 lg:col-span-3 rounded-xl overflow-hidden group cursor-pointer"
            style={{
          ...
          <div
            onClick={() =>
              window.open(
                "https://www.ndtv.com/india-news/air-forces-mig-29-crashes-near-agra-6941456?utm_source=chatgpt.com",
              )
            }
            className="relative col-span-1 sm:col-span-2 lg:col-span-6 rounded-xl overflow-hidden group cursor-pointer"
            style={{
      ...
      <section className="w-full bg-black text-white py-16 sm:py-20 flex items-center px-6 sm:px-10 lg:px-20">
        ...
        text-[36px] sm:text-[48px] md:text-[64px] lg:text-[60px] mb-8"
            ...
            <p className="text-gray-400 text-[14px] sm:text-[16px] leading-relaxed max-w-[420px]">
              ...
              displays, a head-up display, and advanced avionics to present
              real-time flight, radar, navigation, and weapon data, enabling
              faster pilot decision-making and improved situational awareness
        ...
        <div className="max-w-[1500px] mx-auto px-6 lg:px-10">
          ...
          >
            ...
            <div>
              ...
              <p className="text-gray-400 mt-3">Fuel per hour</p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-400 mt-3">Maintenance per flight hour</p>
            </div>
          </motion.div>
