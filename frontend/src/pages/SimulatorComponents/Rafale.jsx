    ...
    return (
        <div>
            ...
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:items-end">
                    ...
                    <div className="text-[13px] sm:text-[14px] leading-relaxed text-gray-300 max-w-[420px]">
                        Two variants of the Rafale include the Rafale B twin-seat fighter used
            ...
            >
                ...
                <div className="max-w-[1700px] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 auto-rows-[220px] sm:auto-rows-[240px] lg:auto-rows-[260px] gap-6">
                    ...
                    {/* HERO BLOCK */}
                    <div
                        onClick={() => navigate("/rafale-case-study-1")}
                    ...
                    >
                        ...
                        <div className="absolute bottom-6 sm:bottom-8 lg:bottom-10 left-6 sm:left-8 lg:left-10 max-w-[420px]">
                            ...
                            <p className="text-gray-300 text-sm hidden sm:block">
                                The Dassault Rafale is a 4.5-generation multirole fighter developed by
                                the French aerospace company Dassault Aviation.
                            </p>
                    ...
                    {/* SMALL CARD */}
                    <div
                        onClick={() => navigate("/rafale-case-study-2")}
                    ...
                    {/* SMALL CARD */}
                    <div
                        onClick={() => navigate("/rafale-case-study-3")}
                        className="relative col-span-1 lg:col-span-3 rounded-xl overflow-hidden group cursor-pointer"
                        style={{
                    ...
                    {/* WIDE CARD */}
                    <div
                        onClick={() => navigate("/rafale-case-study-4")}
                    ...
                    {/* SMALL */}
                    <div
                        onClick={() => navigate("/rafale-case-study-5")}
                        className="relative col-span-1 lg:col-span-3 rounded-xl overflow-hidden group cursor-pointer"
                        style={{
                    ...
                    {/* MEDIUM */}
                    <div
                        onClick={() => navigate("/rafale-case-study-6")}
                        className="relative col-span-1 lg:col-span-3 rounded-xl overflow-hidden group cursor-pointer"
                        style={{
                    ...
                    {/* WIDE CARD */}
                    <div
                        onClick={() => navigate("/rafale-case-study-7")}
                        className="relative col-span-1 sm:col-span-2 lg:col-span-6 rounded-xl overflow-hidden group cursor-pointer"
                        style={{
        ...
        text-[36px] sm:text-[48px] md:text-[64px] lg:text-[60px] mb-8"
                        ...
                        <p className="text-gray-400 text-[14px] sm:text-[16px] leading-relaxed max-w-[420px]">
                            The Dassault Rafale comes in two variants—the Rafale B (two-seat) and
                            Rafale C (single-seat)—both featuring a fully digital glass cockpit
                            with HUD, multifunction displays, HOTAS, and advanced sensor fusion
                            for integrated mission management.
                        </p>
