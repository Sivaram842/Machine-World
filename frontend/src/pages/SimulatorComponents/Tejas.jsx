    ...
    return (
        <div>
            ...
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:items-end">
                    ...
                    <div className="text-[13px] sm:text-[14px] leading-relaxed text-gray-300 max-w-[420px]">
                        The HAL Tejas Mk2 is a next-generation Indian multirole fighter designed
                        for superior air combat, advanced avionics, and enhanced range and
                        payload compared to earlier Tejas variants.
                    </div>
            ...
            >
                ...
                <div className="max-w-[1700px] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 auto-rows-[220px] sm:auto-rows-[240px] lg:auto-rows-[260px] gap-6">
                    ...
                    {/* HERO BLOCK */}
                    <div
                        onClick={() => navigate("/tejas-case-study-1")}
                    ...
                    >
                        ...
                        <div className="absolute bottom-6 sm:bottom-8 lg:bottom-10 left-6 sm:left-8 lg:left-10 max-w-[420px]">
                            ...
                            <p className="text-gray-300 text-sm hidden sm:block">
                                The HAL Tejas Light Combat Aircraft (LCA) program represents one of the
                                most ambitious aerospace projects undertaken by India.
                            </p>
                        </div>
                    </div>
                    ...
                    {/* SMALL CARD */}
                    <div
                        onClick={() => navigate("/tejas-case-study-2")}
                    ...
                    {/* SMALL CARD */}
                    <div
                        onClick={() => navigate("/tejas-case-study-3")}
                        className="relative col-span-1 lg:col-span-3 rounded-xl overflow-hidden group cursor-pointer"
                        style={{
                    ...
                    {/* WIDE CARD */}
                    <div
                        onClick={() => navigate("/tejas-case-study-4")}
                    ...
                    {/* SMALL */}
                    <div
                        onClick={() => navigate("/tejas-case-study-5")}
                        className="relative col-span-1 lg:col-span-3 rounded-xl overflow-hidden group cursor-pointer"
                        style={{
                    ...
                    {/* MEDIUM */}
                    <div
                        onClick={() => navigate("/tejas-case-study-6")}
                        className="relative col-span-1 lg:col-span-3 rounded-xl overflow-hidden group cursor-pointer"
                        style={{
                    ...
                    {/* WIDE CARD */}
                    <div
                        onClick={() => navigate("/tejas-case-study-7")}
                        className="relative col-span-1 sm:col-span-2 lg:col-span-6 rounded-xl overflow-hidden group cursor-pointer"
                        style={{
            ...
            <section className="w-full bg-black text-white py-16 sm:py-20 flex items-center px-6 sm:px-10 lg:px-20">
                ...
                <div className="max-w-[1800px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full">
                    ...
                    <div className="max-w-[620px]">
                        ...
                        <h2 className="font-semibold leading-[0.95] tracking-tight
        text-[36px] sm:text-[48px] md:text-[64px] lg:text-[60px] mb-8">
                        ...
                        <p className="text-gray-400 text-[14px] sm:text-[16px] leading-relaxed max-w-[420px]">
                            The cockpit of the HAL Tejas Mk2 is a modern glass cockpit featuring a
                            panoramic wide-area display, advanced avionics, HOTAS controls, and
                            integrated sensor fusion to give pilots high situational awareness
            ...
            </section><section className="w-full bg-black text-white py-16 sm:py-20 lg:py-24">
                    ...
                    >
                        ...
                        {[
                            ...
                            <motion.span
                                ...
                                className={`block
            ${i === 1 ? "bg-gradient-to-r from-white via-gray-300 to-gray-500 bg-clip-text text-transparent"
                                        : i === 4 ? "text-gray-500"
                                            : i === 3 ? "text-gray-300"
                                                : ""}`}
                            >
