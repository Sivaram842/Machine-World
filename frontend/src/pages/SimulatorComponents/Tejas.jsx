...
import Mig29K1 from "../../assets/Tejas1.jpg";
import Mig29K2 from "../../assets/Tejas2.jpg";
import Mig29K3 from "../../assets/Tejas3.jpg";
import Mig29K4 from "../../assets/Tejas4.png";
import Mig29K5 from "../../assets/Tejas5.jpg";
import Mig29K6 from "../../assets/Tejas6.jpg";
import Mig29K7 from "../../assets/Tejas7.jpg";
...
import RafaleImg from "../../assets/TejasImg.png";
import rafaleCockpit from "../../assets/tejas-cockpit.jpg";
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:items-end">
          ...
          <div className="text-[13px] sm:text-[14px] leading-relaxed text-gray-300 max-w-[420px]">
            The HAL Tejas Mk2 is a next-generation Indian multirole fighter
            designed for superior air combat, advanced avionics, and enhanced
            range and payload compared to earlier Tejas variants.
          </div>
      ...
      >
        <div className="max-w-[1700px] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 auto-rows-[220px] sm:auto-rows-[240px] lg:auto-rows-[260px] gap-6">
          ...
          <div
            onClick={() =>
              window.open(
                "https://ncaacademy.com/hal-tejas-mk-1-indias-indigenous-fighter-jet-a-powerful-story-of-innovation-courage-success-2025-update/",
              )
            }
          ...
          >
            ...
            <div className="absolute bottom-6 sm:bottom-8 lg:bottom-10 left-6 sm:left-8 lg:left-10 max-w-[420px]">
              <h3 className="text-xl sm:text-2xl lg:text-3xl font-semibold mb-3 group-hover:-translate-y-1 transition">
                Development of India’s Indigenous Fighter – HAL Tejas
              </h3>

              <p className="text-gray-300 text-sm hidden sm:block">
                The HAL Tejas Light Combat Aircraft (LCA) program represents one
                of the most ambitious aerospace projects undertaken by India.
              </p>
            </div>
          </div>
          ...
          <div
            onClick={() =>
              window.open(
                "https://iadnews.in/100-km-range-astra-missile-successfully-tested-to-be-equipped-on-tejas-mark-1a-jet/?utm_source=chatgpt.com",
              )
            }
          ...
          >
            ...
            <div className="absolute bottom-6 left-6 right-6">
              <h4 className="text-lg font-semibold">
                Tejas Operational Deployment in the Indian Air Force
              </h4>
            </div>
          </div>
          ...
          <div
            onClick={() =>
              window.open(
                "https://indianexpress.com/article/india/indigenously-developed-tejas-aircraft-to-make-debut-at-foreign-air-exercise-8466529/",
              )
            }
            className="relative col-span-1 lg:col-span-3 rounded-xl overflow-hidden group cursor-pointer"
            style={{
          ...
          >
            ...
            <div className="absolute bottom-6 left-6 right-6">
              <h4 className="text-lg font-semibold">
                Tejas in International Military Exercises
              </h4>
            </div>
          </div>
          ...
          <div
            onClick={() =>
              window.open(
                "https://www.pib.gov.in/PressReleasePage.aspx?PRID=1951428&utm_source=chatgpt.com&reg=3&lang=2",
              )
            }
          ...
          >
            ...
            <div className="absolute bottom-6 sm:bottom-8 left-6 sm:left-8 max-w-[400px]">
              <h3 className="text-lg sm:text-xl font-semibold">
                Integration of Indigenous Weapons and Radar Systems
              </h3>
            </div>
          </div>
          ...
          <div
            onClick={() =>
              window.open(
                "https://timesofindia.indiatimes.com/india/naval-version-of-tejas-undergoes-successful-tests/articleshow/65247653.cms",
              )
            }
            className="relative col-span-1 lg:col-span-3 rounded-xl overflow-hidden group cursor-pointer"
            style={{
          ...
          >
            ...
            <div className="absolute bottom-6 left-6">
              <h4 className="text-lg font-semibold">
                Tejas Naval Variant – Aircraft Carrier Operations
              </h4>
            </div>
          </div>
          ...
          <div
            onClick={() =>
              window.open(
                "https://www.pib.gov.in/PressReleasePage.aspx?PRID=2180339&reg=3&lang=2",
              )
            }
            className="relative col-span-1 lg:col-span-3 rounded-xl overflow-hidden group cursor-pointer"
            style={{
          ...
          >
            ...
            <div className="absolute bottom-6 left-6">
              <h4 className="text-lg font-semibold">
                Tejas Mk1A – Modernization and Mass Production Program
              </h4>
            </div>
          </div>
          ...
          <div
            onClick={() =>
              window.open(
                "https://indianexpress.com/article/cities/pune/missile-astra-lca-tejas-test-fired-9884805/?utm_source=chatgpt.com",
              )
            }
            className="relative col-span-1 sm:col-span-2 lg:col-span-6 rounded-xl overflow-hidden group cursor-pointer"
            style={{
      ...
      <section className="w-full bg-black text-white py-16 sm:py-20 flex items-center px-6 sm:px-10 lg:px-20">
        ...
        text-[36px] sm:text-[48px] md:text-[64px] lg:text-[60px] mb-8"
            ...
            <p className="text-gray-400 text-[14px] sm:text-[16px] leading-relaxed max-w-[420px]">
              The cockpit of the HAL Tejas Mk2 is a modern glass cockpit
              featuring a panoramic wide-area display, advanced avionics, HOTAS
              controls, and integrated sensor fusion to give pilots high
              situational awareness during combat missions.
            </p>
          </div>
        ...
        <div className="max-w-[1500px] mx-auto px-6 lg:px-10">
          ...
          >
            ...
            <div>
              ...
              <p className="text-gray-400 mt-3">
                Maintenance per year <br /> (per aircraft)
              </p>
            </div>
          </motion.div>
