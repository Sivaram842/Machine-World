...
function Header() {
  ...
  return (
    <header className="relative w-full h-screen overflow-hidden">
      {/* VIDEO */}
      <video
        onClick={() => navigate("/rafale")}
        className="absolute inset-0 w-full h-full object-cover"
        src="/herovedio-optimized.mp4"
        autoPlay
        muted
        loop
        playsInline
  ...
  return (
    <section className="w-full bg-black px-6 lg:px-12 py-12">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        {/* Wide Card */}
        <div
          onClick={() => navigate("/su-30mki")}
          className="relative overflow-hidden group md:col-span-2 h-full"
        >
          <img
    ...
    <section className="w-full bg-black min-h-screen flex items-center justify-center">
      ...
      `}
        ...
        <p className="mt-8 text-neutral-400 max-w-xl mx-auto text-[15px] sm:text-[16px] leading-relaxed tracking-[0.02em]">
          ...
          to support modern defense operations. Teams can train, test and
          prepare in realistic environments across aerial and ground warfare.
        </p>
      </div>
    </section>
  );
      ...
      <div className="w-full px-6 sm:px-10 lg:px-20 grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
        ...
        <div className="max-w-[640px]">
          ...
          <p className="text-neutral-400 text-base leading-relaxed max-w-lg mb-6">
            The demand for training continues to grow every day across air and
            land. Traditional simulation methods, such as room-scale domes,
            cannot keep pace with today's rising requirements.
          </p>

          <p className="text-neutral-400 text-base leading-relaxed max-w-lg mb-6">
            Mixed reality technology can bridge that gap, with training
            solutions that are more portable and more immersive than ever
            before.
          </p>

          <button
            onClick={() => navigate("/whyxr")}
  ...
  ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-[220px]"}`}
    ...
    object-cover rounded-xl border border-gray-800"
          ...
          <p className="mt-6 text-center text-neutral-300 text-[16px] sm:text-[18px] lg:text-[20px] italic tracking-[0.02em] max-w-3xl mx-auto leading-relaxed">
            High-fidelity simulation environments designed for aerospace
            organizations to test aircraft systems and train pilots in realistic
            conditions.
          </p>
        </div>
      </div>
