          ...
          <div className="w-full px-6 md:px-[5.5vw] pb-[12vh] md:pb-[15vh]">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mt-20 items-start">
              ...
              <div className="md:col-span-6 md:justify-self-end">
                <p className="text-[14px] sm:text-[15px] md:text-[16px] leading-[1.7] max-w-[430px] text-white/80">
                  Spatial computing platforms power interactive XR entertainment
                  worlds, allowing audiences to explore, play and engage inside
                  immersive digital environments like never before.
                </p>
              </div>
            </div>
          </div>
...
"
              ...
              {/* Bullet List */}
              <p className="text-[14px] md:text-[15px] leading-[1.7] text-[#1a1a1a] max-w-[520px]">
                Build immersive gaming worlds, XR theme park attractions and
                interactive storytelling experiences. Support multiplayer
                environments and high-fidelity simulations for racing, aviation
                and next-generation entertainment platforms.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="w-full min-h-screen bg-[#f3f3f3] flex items-center justify-center">
        <div className="w-full max-w-[1100px] mx-auto px-[6vw] text-center">
          ...
          <p className="mt-10 max-w-[520px] mx-auto text-[16px] md:text-[18px] text-black/60 leading-[1.7]">
            Entertainment studios are adopting spatial XR platforms to build
            interactive digital experiences, blending physical and virtual
            environments to create entirely new forms of audience engagement.
          </p>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="pt-[60px] pr-[5vw]">
            ...
            <p className="text-[20px] md:text-[27px] leading-[1.4] italic font-light text-black mb-[18px]">
              “XR environments allow audiences to step inside and interact with
              digital entertainment worlds. Transform passive viewing into fully
            ...
            <button
              ...
              className="bg-black text-white px-[30px] py-[14px] uppercase text-[11px] tracking-[0.12em] hover:bg-black/80 transition"
            >
              READ CASE STUDY →
            </button>
          </div>
          ...
          <div className="w-full md:w-[45%] flex items-center">
            <div className="max-w-[580px]">
              ...
              <h2 className="uppercase text-[28px] md:text-[46px] font-extrabold leading-[1.1] mb-[26px]">
                IMMERSIVE XR ENTERTAINMENT EXPERIENCES
              </h2>

              {/* Paragraph */}
              <p className="text-[17px] leading-[1.7] text-black/70 mb-[40px] max-w-[520px]">
                Platforms designed for interactive gaming, XR attractions and
                immersive storytelling, powered by real-time spatial simulations
                that enable large-scale entertainment experiences.
              </p>
      ...
      <section
        ...
        style={{
          backgroundImage: `url(${entertainment7})`,
      ...
      >
        ...
        <div className="relative ml-[4vw] max-w-[560px]">
          ...
          <ul className="text-[15px] md:text-[16px] leading-[1.75] text-white/80 mb-10 max-w-[520px] space-y-2">
            <li>
              {" "}
              Spatial computing systems powering interactive entertainment
              platforms.
            </li>
            <li>
              {" "}
              Tools for creators to build immersive digital environments for
              global audiences.
            </li>
          </ul>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start gap-12 md:gap-[7vw]">
            ...
            <div className="w-full md:w-[40%]">
              ...
              <h2 className="uppercase text-[44px] font-extrabold leading-[1.08] mb-[26px]">
                DESIGNED FOR TRUE TO LIFE IMMERSION.
              </h2>

              {/* Paragraph */}
              <p className="text-[16px] leading-[1.7] text-black/70 max-w-[460px]">
                High-fidelity visuals combined with natural spatial interaction
                enable long-duration immersive experiences, supported by
                advanced rendering systems built for realistic digital
                environments.
              </p>
            </div>
