...
const cards = [
  {
    ...
    desc: "Doom Industries cockpit simulators replicate modern jet aircraft environments, allowing pilots to train on navigation, systems management, and flight procedures in fully immersive virtual cockpits.",
  ...
  },
  {
    ...
    desc: "Doom Industries training systems allow full mission rehearsal including navigation, threat environments, and operational decision making in high-fidelity simulation environments.",
  ...
  return (
    <div>
      ...
      <section className="relative h-screen w-full overflow-hidden bg-black text-white">
        ...
        "
                >
                  Doom Industries’ immersive simulation systems combine XR
                  technology, realistic cockpit hardware, and spatial computing
                  platforms to create highly accurate training environments.
                  From pilot training to ground vehicle operations, teams can
                  practice complex missions in safe, repeatable simulations
                  while dramatically reducing the cost of traditional training.
                </p>
              </div>
            </div>
          </div>
...
"
              ...
              <ul className="list-disc list-outside pl-4 space-y-3 text-[14px] md:text-[15px] leading-[1.65] text-[#1a1a1a]">
                <li>
                  Reduce training costs dramatically using immersive cockpit
                  simulators and XR environments instead of expensive live
                  training missions
                </li>

                <li>
                  Accelerate learning with realistic spatial simulations that
                  allow pilots and operators to practice repeatedly
                </li>

                <li>
                  Improve engagement and skill retention through immersive,
                  interactive training experiences
                </li>

                <li>
                  Integrate physical cockpit hardware with virtual environments
                  using DAS spatial computing technology
                </li>

                <li>
                  Enable portable training systems that allow organizations to
                  train personnel anywhere
                </li>

                <li>
                  Safely simulate dangerous scenarios such as system failures,
                  combat missions, and emergency situations
                </li>
              </ul>
            </div>
          </div>
      ...
      <section className="w-full min-h-screen bg-[#f3f3f3] flex items-center justify-center">
        <div className="w-full max-w-[1100px] mx-auto px-[6vw] text-center">
          <h2 className="uppercase font-light text-[24px] md:text-[40px] leading-[1.4] tracking-[0.03em] text-[#111111]">
            ...
            <br />
            DOOM INDUSTRIES TRAINING SYSTEMS
          </h2>
          ...
          <p className="mt-8 md:mt-12 text-[16px] md:text-[19px] leading-[1.7] text-[#555555] max-w-[520px] mx-auto">
            ...
            using Doom Industries simulation technologies to modernize training.
            By combining immersive XR software, spatial computing platforms, and
            realistic cockpit hardware, teams can prepare for complex operations
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="pt-[60px] pr-[5vw]">
            ...
            <p className="text-[20px] md:text-[27px] leading-[1.4] italic font-light text-black mb-[18px]">
              Doom Industries’ immersive training systems allow our teams to
              rehearse complex missions repeatedly while maintaining extremely
              high levels of realism. It has transformed how we prepare
          ...
          <div className="w-full md:w-[45%] flex items-center">
            <div className="max-w-[580px]">
              ...
              <h2 className="uppercase text-[28px] md:text-[46px] font-extrabold leading-[1.1] mb-[26px]">
                ADVANCED HELICOPTER TRAINING SIMULATION
              </h2>

              {/* Paragraph */}
              <p className="text-[17px] leading-[1.7] text-black/70 mb-[40px]">
                Doom Industries develops immersive helicopter training
                environments that combine realistic cockpit hardware with XR
                simulation software. Pilots can interact with physical controls
                while operating inside a high-fidelity digital environment
                powered by the DAS spatial computer and REALM simulation
                platform. These systems enable mission rehearsal, emergency
                procedure training, and tactical flight exercises without the
                operational costs of real aircraft deployment.
              </p>
      ...
      >
        ...
        <div className="relative ml-[4vw] max-w-[560px]">
          ...
          <p className="uppercase text-[12px] tracking-[0.18em] font-light mb-6 text-white/80">
            THE DOOM INDUSTRIES TRAINING ADVANTAGE
          </p>
          ...
          <p className="text-[15px] md:text-[16px] leading-[1.75] text-white/80 mb-10 max-w-[520px]">
            Doom Industries simulation technologies combine immersive XR
            environments, high-performance spatial computing, and realistic
            hardware integration to deliver next-generation training systems.
          ...
          <div className="flex flex-col md:flex-row justify-between items-start gap-12 md:gap-[7vw]">
            ...
            <div className="w-full md:w-[40%]">
              ...
              <p className="text-[16px] leading-[1.7] text-black/70 max-w-[460px]">
                Doom Industries simulation systems are designed to deliver
                highly realistic training experiences. High-resolution displays,
                advanced tracking systems, and immersive spatial environments
                allow trainees to interact naturally with cockpit controls,
                instruments, and mission systems. This combination of physical
                hardware and digital environments creates training scenarios
                that closely mirror real operational conditions.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-14 items-start">
            ...
            <div className="relative aspect-square overflow-hidden group">
              ...
              <div className="absolute bottom-10 left-10 right-10 text-white">
                ...
                <p className="text-[15px] leading-[1.6] text-white/90">
                  Discover how Doom Industries cockpit simulators combine
                  physical controls and immersive XR environments to create
                  highly realistic pilot training systems.
                </p>
              </div>
            </div>
            ...
            <div className="relative h-[350px] md:h-[500px] overflow-hidden group">
              ...
              <div className="absolute bottom-12 left-10 right-10 text-white">
                ...
                <p className="text-[16px] leading-[1.6] text-white/90">
                  Doom Industries simulation platforms enable defense
                  organizations to train personnel in complex mission scenarios
                  using immersive XR environments and realistic cockpit systems.
                </p>
              </div>
            </div>
            ...
            <div className="relative h-[500px] overflow-hidden group">
              ...
              <div className="absolute bottom-12 left-10 right-10 text-white">
                ...
                <p className="text-[16px] leading-[1.6] text-white/90">
                  Learn how the DAS Spatial Computer and REALM platform enable
                  immersive multi-user training environments for aviation,
                  defense, and enterprise industries.
                </p>
              </div>
            </div>
          </div>
