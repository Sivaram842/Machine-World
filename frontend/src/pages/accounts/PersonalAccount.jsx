...
export default function PersonalAccount({ setPage }) {
  ...
  return (
    <div className="max-w-[520px] w-full mx-auto mt-12 sm:mt-16 lg:mt-20 px-4 sm:px-6">
      {/* Title */}
      <h1 className="text-2xl sm:text-3xl font-medium">Personal account</h1>
      ...
      <p className="text-xs sm:text-sm text-gray-600 leading-relaxed mb-8 sm:mb-10">
        Personal accounts are intended only for non-commercial use of Doom
        Industries headsets and cannot be used to access services purchased by
        an organization.
      </p>
