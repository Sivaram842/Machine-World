...
export default function Jobs() {
  ...
  const rightContent = {
    ...
    salary:
      "We value the skills, dedication, and creativity our team brings. As our company grows, we ensure competitive compensation and opportunities to grow with us.",
    global:
      "Our technologies are designed for global industries including defence, enterprise training, and immersive simulation systems.",
      ...
      <div className="font-sans text-black overflow-x-hidden">
        ...
        <section className="relative h-[70vh] md:h-[85vh] lg:h-screen flex items-center justify-center text-white">
          ...
          <div className="relative z-10 text-center px-6 max-w-[900px]">
            ...
            <p className="mt-6 text-[15px] sm:text-[17px] md:text-[20px] leading-[28px] md:leading-[34px] max-w-[800px] mx-auto">
              We develop cockpit simulators, XR technologies, training systems,
              and defence solutions that help industries innovate, train
              smarter, and operate safely.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 px-6 md:px-16 items-center">
            ...
            <div>
              ...
              <div className="mt-8 space-y-6 text-[15px] sm:text-[16px] md:text-[17px] leading-[26px] md:leading-[30px] text-gray-700">
                ...
                <p>
                  With a multidisciplinary team of designers, software
                  developers, hardware engineers, and XR specialists, we build
                  innovative solutions that combine software, hardware, and
          ...
          <div className="max-w-[1600px] mx-auto px-6 md:px-16 grid grid-cols-1 lg:grid-cols-2 gap-10">
            <div className="flex flex-col gap-10">
              ...
              <div className="bg-[#f3f3f3] p-6 md:p-12 h-auto md:h-[520px] flex flex-col justify-between">
                <h3 className="uppercase font-bold text-[22px]">
                  Design & XR Team
                </h3>
                <p className="italic text-[18px]">
                  “Immersive technologies like VR and MR are transforming the
                  way people learn and train.”
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-10">
              <div className="relative overflow-hidden h-auto md:h-[400px]">
                ...
                <div className="absolute bottom-6 left-6 text-white">
                  ...
                  <p className="italic mt-4 max-w-[350px]">
                    “Combining hardware and software is what enables real-world
                    defence solutions.”
                  </p>
                </div>
              </div>
              ...
              <div className="bg-[#f3f3f3] p-6 md:p-12 h-auto md:h-[400px] flex flex-col justify-between">
                ...
                <p className="italic text-[18px]">
                  “Simulation systems allow industries to train efficiently
                  while reducing real-world costs.”
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 md:py-32 lg:py-40">
          <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-32 px-6 md:px-16 items-center">
            <div>
              ...
              <p className="mt-10 text-[15px] sm:text-[17px] md:text-[18px] leading-[26px] md:leading-[34px] text-gray-700">
                Our goal is to push the boundaries of simulation and immersive
                technologies while building meaningful solutions for defence and
                enterprise sectors.
              </p>
            </div>
          ...
          <div className="max-w-[1600px] mx-auto px-6 md:px-16">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12">
              {[
                ...
                >
                  <h3
                    className="uppercase font-bold text-[18px] md:text-[22px] 
