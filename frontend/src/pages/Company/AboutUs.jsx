      ...
      <div className="font-varjo text-black overflow-x-hidden">
        ...
        <section className="bg-[#D3D3D3] py-20 md:py-32 text-center">
          <div className="max-w-[980px] mx-auto px-6">
            ...
            <p className="mt-8 text-[15px] sm:text-[17px] md:text-[18px] leading-[26px] md:leading-[32px] text-gray-600 max-w-[720px] mx-auto">
              At Doom Industries we develop advanced simulation systems, <br />
        ...
        <section className="bg-[#f3f3f3] py-20 md:py-32">
          <div className="max-w-[1400px] mx-auto px-6 md:px-16 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
            <div>
              <p className="uppercase tracking-[3px] text-xs mb-6">
                WHO WE ARE
              </p>
              ...
              <div className="mt-8 space-y-6 text-[15px] sm:text-[16px] md:text-[17px] leading-[26px] md:leading-[28px] text-gray-600 max-w-[520px]">
                <p>
                  ...
                  solutions. Our work combines software, hardware, and immersive
                  technologies to create powerful training and simulation
                  systems.
                </p>

                <p>
                  Our team develops applications such as cockpit simulators,
                  counter-drone systems, and XR-based training environments for
                  defence, education, and enterprise sectors.
                </p>

                <p>
                  With a multidisciplinary team of designers, developers, XR
                  engineers, and hardware specialists, we focus on building
                  innovative systems that improve training efficiency, reduce
                  costs, and enable safe experimentation.
                </p>
              </div>
          ...
          <div className="max-w-[1400px] mx-auto px-6 md:px-16">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12 md:gap-24 text-gray-700">
              ...
              <div>
                ...
                <p>
                  Doom Industries Development Lab <br />
          ...
          <div className="max-w-[1400px] mx-auto px-6 md:px-16 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="mt-8 text-gray-400 text-[15px] md:text-[17px] leading-[26px] md:leading-[30px] max-w-[560px]">
                Real-world training environments are expensive, complex, and
                sometimes risky. Simulation technology allows teams to practice
                critical skills safely while reducing operational costs.
              </p>

              <p className="mt-8 text-gray-400 text-[15px] md:text-[17px] leading-[26px] md:leading-[30px] max-w-[560px]">
                At Doom Industries we develop advanced cockpit simulators, XR
                training platforms, and defence technologies that enable
                organizations to train effectively in realistic digital
                environments.
              </p>
            </div>
        ...
        <section className="bg-[#f5f5f5] py-24 md:py-40 text-center px-6">
          <h2 className="text-[28px] sm:text-[36px] md:text-[48px] font-black uppercase">
            Doom Industries Media Kit
          </h2>

          <p className="mt-6 text-gray-600 max-w-[700px] mx-auto">
            Explore Doom Industries technologies, simulation platforms, and
            immersive systems through our media resources, images, and company
            updates.
          </p>
