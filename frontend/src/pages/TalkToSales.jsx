  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(
        `${import.meta.env.VITE_API_URL}/api/talk-to-sales`,
        {
          method: "POST",
        ...
        <div className="flex flex-col lg:flex-row min-h-screen w-full bg-white px-6 sm:px-10 md:px-16 lg:px-24 py-16 md:py-20 box-border gap-16">
          ...
          <div className="flex-1 lg:pr-20">
            ...
            <p className="text-[15px] md:text-[16px] leading-[1.7] text-[#434141] max-w-[520px]">
              Complete the form and our product experts will help you figure out
              the best way to use <strong>Doom Industries</strong> to unlock
              business benefits and create next-generation immersive XR/VR
              experiences.
            </p>
          </div>
