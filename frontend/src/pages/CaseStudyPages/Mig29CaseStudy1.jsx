...
export default function Mig29CaseStudy1() {
    return (
        ...
        text-[16px] md:text-[18px] leading-[28px] md:leading-[32px] text-gray-300">

                        <p>
                            The <strong className="text-white">Mikoyan MiG-29</strong> was developed during the
                            <strong className="text-white"> 1970s</strong> by the Mikoyan Design Bureau in the
                            Soviet Union. The aircraft was designed as a response to
                            advanced American fighter aircraft including the
                            <strong className="text-white"> F-15 Eagle</strong> and
                            <strong className="text-white"> F-16 Fighting Falcon</strong>.
                        </p>
                        ...
                        <p>
                            ...
                            <strong className="text-white"> first flight in 1977</strong> and entered operational
                            service with the Soviet Air Force in
                            <strong className="text-white"> 1983</strong>.
                        </p>
                ...
                <section className="px-4 md:px-6">
                    <div className="max-w-[760px] mx-auto">
                        ...
                        <img
                            src={Mig291}
                            alt="MiG-29 Fighter Aircraft"
                            className="w-full h-[220px] sm:h-[300px] md:h-[420px] object-cover rounded-xl"
                        />
        ...
        text-[16px] md:text-[18px] leading-[28px] md:leading-[32px] text-gray-300">
                        ...
                        <p>
                            The aircraft is powered by two <strong className="text-white">RD-33 turbofan engines</strong>
                ...
                <section className="py-16 md:py-24 px-6">
                    ...
                    <div className="max-w-[760px] mx-auto space-y-6 text-[16px] md:text-[18px] leading-[30px] text-gray-300">

                        <h2 className="text-[24px] font-bold uppercase text-white">
                            Avionics Systems
                        </h2>
                ...
                <section className="py-16 md:py-24 px-6">
                    ...
                    <div className="max-w-[760px] mx-auto space-y-6 text-[16px] md:text-[18px] leading-[30px] text-gray-300">
                        ...
                        <p>
                            ...
                            <strong className="text-white"> 30 countries</strong>.
                        </p>
