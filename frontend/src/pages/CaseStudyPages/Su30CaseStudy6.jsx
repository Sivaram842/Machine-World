        ...
        <div className="bg-[#f3f3f3] text-black">
            ...
            <section className="py-16 md:py-24 px-6">
                <div className="max-w-[760px] mx-auto space-y-6 text-[16px] md:text-[18px] leading-[28px] md:leading-[32px] text-gray-800">
                    ...
                    <p>
                        Although the <strong>Su-30MKI</strong> remains one of the most capable multirole fighter aircraft in service, its original radar system was designed more than two decades ago.
                    </p>
                    ...
                    <p>
                        ...
                        <strong> Virupaksha AESA radar</strong> as part of the Super Sukhoi upgrade initiative.
                    </p>
            ...
            <section className="py-16 md:py-24 px-6">
                <div className="max-w-[760px] mx-auto space-y-6 text-gray-800">
                    ...
                    <p>
                        The original Su-30MKI radar, the <strong>N011M Bars PESA radar</strong>, was considered highly advanced when introduced but now faces challenges against modern combat systems.
                    </p>
            ...
            <section className="py-16 px-6">
                <div className="max-w-[760px] mx-auto space-y-6 text-gray-800">
                    ...
                    <p>
                        To overcome these limitations, India is developing the <strong>Virupaksha Active Electronically Scanned Array (AESA) radar</strong> for the Su-30MKI.
                    </p>

                    <p>
                        The radar is being developed by the <strong>Electronics and Radar Development Establishment (LRDE)</strong> under DRDO, with support from Indian defense companies.
                    </p>
                    ...
                    <p>
                        With this upgrade, the Su-30MKI will evolve into a <strong>“Super Sukhoi” 4.5+ generation fighter</strong>.
                    </p>
