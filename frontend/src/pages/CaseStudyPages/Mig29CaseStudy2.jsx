...
export default function Mig29CaseStudy2() {
    return (
                ...
                <section className="px-4 md:px-6">
                    <div className="max-w-[760px] mx-auto">
                        ...
                        <img
                            ...
                            className="w-full h-[220px] sm:h-[300px] md:h-[420px] object-cover rounded-xl shadow-lg hover:scale-[1.02] transition duration-500"
                        />
        ...
        text-[16px] md:text-[18px] leading-[28px] md:leading-[32px] text-gray-300">
                        ...
                        <p>
                            The <strong className="text-white">Mikoyan MiG-29</strong> participated in combat
                            during the <strong className="text-white">1991 Gulf War</strong>, when Iraqi forces
                        ...
                        <p>
                            ...
                            <strong className="text-white"> late 1980s</strong> as part of an effort to modernize
        ...
        text-[16px] md:text-[18px] leading-[28px] md:leading-[32px] text-gray-300">
                        ...
                        <p>
                            ...
                            such as the <strong className="text-white">F-15 Eagle</strong> and
