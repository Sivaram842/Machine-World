    ...
    return (
      ...
      ">
        ...
        cursor-pointer"
                    ...
                    {/* BLOCK 2 */}
                    <div className="md:row-span-2 min-h-[740px] bg-gray-100 p-10 flex flex-col justify-end transition-all duration-300
        hover:bg-blue-700 hover:text-white
        cursor-pointer">
                        <span className="text-xs tracking-[0.25em] uppercase mb-4">
                            System
        ...
        cursor-pointer"
                    ...
                    {/* BLOCK 4 */}
                    <div className="min-h-[360px] bg-[#d9dcef] p-10 flex flex-col justify-end transition-all duration-300
        hover:bg-blue-700 hover:text-white
        cursor-pointer">
                        <span className="text-xs tracking-[0.25em] uppercase mb-4">
                            Varjo Alpha
                    ...
                    {/* BLOCK 5 */}
                    <div className="min-h-[360px] bg-gray-100 p-10 flex flex-col justify-end transition-all duration-300
        hover:bg-blue-700 hover:text-white
        cursor-pointer">
                        <span className="text-xs tracking-[0.25em] uppercase mb-4">
                            Software
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10">
                    ...
                    {resources.map((item) => (
                       ...
                       hover:bg-blue-700 cursor-pointer flex flex-col"
                        >
                            {/* Title */}
                            <h3 className="text-sm tracking-widest uppercase mb-8 
                          ...
                          group-hover:text-white">
                            ...
                            {/* Arrow */}
                            <span className="mt-6 text-lg group-hover:text-white">
                                →
                            </span>
                        </div>
                    ))}
            ...
            >
                ...
                <div className="relative z-10 h-full flex items-start">
                    <div className="pt-28 pl-16 max-w-lg text-white">
                        ...
                        {/* Button */}
                        <button className="border border-white px-6 py-3 uppercase tracking-wide text-xs 
                ...
                <div className="max-w-7xl mx-auto px-16">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
                        ...
                        <div className="max-w-md">
                            ...
                            {/* Button */}
                            <button className="bg-black text-white px-8 py-4 uppercase tracking-wide text-sm 
                    ...
                    <div className="flex flex-col lg:flex-row justify-between items-start gap-12">
                        ...
                        <div className="max-w-xl">
                            ...
                            <p className="text-gray-300 leading-relaxed">
                                Get early access to product information, exclusive offers, in-depth
                                insights into the world of VR and XR and stay connected with the
                        ...
                        <div className="max-w-md w-full">
                           ...
                           focus:outline-none focus:border-white py-2 text-gray-300"
                            ...
                            {/* Button */}
                            <button className="bg-white text-black px-10 py-4 uppercase text-sm 
