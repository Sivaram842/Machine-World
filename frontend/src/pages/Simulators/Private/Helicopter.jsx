        ...
        <div className="w-full">
          ...
          <div className="grid grid-cols-4 gap-10 items-start">
            ...
            <div className="text-xs text-gray-700 leading-relaxed max-w-[320px]">
              Doom Industries develops advanced simulation platforms designed
              for aviation, industrial operations, and technical training. Our
              immersive systems help organizations train professionals, test
              complex scenarios, and improve operational readiness without the
              risks or costs of real-world environments.
            </div>
      ...
      <div className="bg-white text-black">
          ...
          <div className="max-w-[1400px] mx-auto grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="mt-6 text-gray-700 text-[16px] leading-[28px]">
                Varjo Base is the essential link between your hardware and your
                workflow. <br />
                Whether you’re deploying a single headset or managing an entire
                XR lab, Varjo <br />
                Base is designed to put you in control to get the most out of
                the headset.
              </p>

              <ul className="mt-6 space-y-3 text-gray-700 text-[15px]">
                <li>
                  • Easily control headset capabilities such as eye tracking,
                  foveated rendering and visual quality.
                </li>
                <li>
                  • Make adjustments to the mixed reality experience, altering
                  how virtual and real worlds blend together.
                </li>
                <li>
                  • Manage supporting tools such as tracking devices and
                  controllers.
                </li>
                <li>
                  • Manage supporting tools such as tracking devices and
        ...
        <section className="py-20 md:py-28 px-6 text-center">
          <div className="max-w-[700px] mx-auto">
            ...
            <p className="mt-6 text-gray-700 leading-[28px]">
              Security isn’t an afterthought in Varjo Base—it’s built into{" "}
              <br />
            ...
            <p className="mt-6 text-gray-700 leading-[28px]">
              Updates are digitally signed for authenticity, and no data is{" "}
              <br />
              ...
              Base ensures your XR experience stays secure and under
              <br />
              ...
              <div>
                <h2
                  className="uppercase font-extrabold 
                                       ...
                                       leading-[1.2] tracking-tight"
                >
                  Varjo Base Pro: Unlock the full
                  <br />
                  potential of your XR-4 Series
                  <br />
                  headset.
                </h2>

                <p className="mt-6 text-gray-700 leading-[28px]">
                  Varjo Base is free-of-charge, but for the most advanced
                  features you will need <br />
                  Varjo Base Pro. Gain access to advanced features, deeper
                  customization, and <br />
                  enhanced data insights to elevate your workflows and deliver
                  next-level
                  <br />
                  performance.
                </p>
                ...
                <ul className="mt-6 space-y-3 text-gray-700 text-[15px]">
                  <li>
                    • Advanced VR and MR features, such as chroma key, advanced
                    masking tools, and programmatic control over camera
                    settings.
                  </li>
                  <li>
                    • Eye tracking for research and analytics, offering deeper
                    insights with features like gaze data API and the eye camera
                    data stream
                  </li>
                  <li>
                    • Custom tracking solutions, including third-party tracking
                    plugin support and motion platform compatibility.
                  </li>
                  <li>
                    • Future software innovations, with access to a roadmap of
                    new capabilities and ongoing enhancements to tracking,
                    passthrough, and AI-assisted features.
                  </li>
                </ul>

                <p className="mt-6 text-gray-700 leading-[28px]">
                  Pricing starts at 2,500€/$ per year, or 5,000€/$ perpetual for
                  Varjo XR-4 and <br />
                  Varjo XR-4 Focal Edition. Varjo Base Pro license is included
                  in Varjo XR-4 Secure <br />
                  Edition devices.
                </p>
        ...
        <section className="py-24 px-6 text-center">
          <div className="max-w-[700px] mx-auto">
            ...
            <p className="mt-6 text-gray-700 leading-[28px]">
              Varjo Base is continuously updated to deliver the best
              <br />
              possible XR experience—enhancing performance, <br />
              stability, and usability with every release. New versions
              <br />
              drop roughly every two months, introducing powerful new <br />
              features while refining existing ones based on real user <br />
              feedback. The core platform is designed to grow with you,
              <br />
                ...
                <div>
                  <h3
                    className="uppercase font-extrabold 
                                                 ...
                                                 transition-colors duration-300"
                  >
                    Varjo Launches Ready-To-Deploy XR Systems For Secure And
                  ...
                  <p
                    className="mt-4 sm:mt-6 text-gray-700 
                                                ...
                                                transition-colors duration-300"
                  >
                    The bundle offering combines XR-4 Series headsets, certified
                    workstations, and software into a single, deployable XR
                    system suitable for air-gapped environments.
                  </p>
                </div>
              </div>
