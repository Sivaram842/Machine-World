...
import img6 from "../../../assets/SimulatorSolutions.jpeg";
const blocksData = [
  {
    title: "Tejas",
          ...
          <div className="grid md:grid-cols-3 gap-10">
            <div>
              ...
              <p className="text-white/70">
                High fidelity cockpit simulators allow pilots to practice flight
                operations and emergency procedures safely.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-white/70">
                Multiple pilots and command teams can train together inside
