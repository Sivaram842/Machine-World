...
"
        ...
        <div className="flex flex-wrap gap-12 sm:gap-16">
          {/* COMPANY */}
          <div>
            <p className="text-xs tracking-wider text-gray-400 mb-4">COMPANY</p>
          ...
          {/* SOCIAL */}
          <div>
            <p className="text-xs tracking-wider text-gray-400 mb-4">SOCIAL</p>
      ...
      <div className="border-t border-neutral-800 pt-8 flex flex-col md:flex-row justify-between gap-10">
        ...
        <div>
          <p className="text-xs mb-4">
            COPYRIGHT © 2026 DOOM INDUSTRIES. ALL RIGHTS RESERVED.
          </p>
        ...
        <div className="md:text-right">
          <p className="text-xs text-gray-400 mb-3 tracking-wider">CONTACT</p>

          <p className="text-sm break-all">
            sashank@doomindustries.com
            <br />
            contact@doomindustries.com
          </p>
        </div>
      </div>
    </footer>
