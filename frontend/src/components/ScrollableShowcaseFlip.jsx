                ...
                <div className="w-full lg:w-1/2 bg-[#f2f2f2] flex items-center py-16 lg:py-0">
                    <div className="px-4 sm:px-8 lg:px-16 max-w-xl">
                        ...
                        <p className="text-base text-gray-600 leading-relaxed">
                            ...
                            or XR glasses. You unlock advanced spatial software,
                            modular hardware, and seamless AI-powered experiences.
                            Our platform empowers creators, students, and innovators
                            to design, build, and collaborate in entirely new ways.
                        </p>
                    </div>
                </div>
