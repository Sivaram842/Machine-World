  ...
  return (
    ...
    "
      ...
      <div
        className={
          mobileOpen
            ? "fixed top-16 left-0 w-full h-[calc(100vh-64px)] bg-white overflow-y-auto lg:hidden px-6 py-6 space-y-6"
            : "hidden"
        }
      >
          ...
          <div>
            ...
            {mobileProducts && (
              <div className="mt-4 space-y-3 text-gray-700">
                ...
                <p onClick={() => navigate("/demo")} className="cursor-pointer">
                  Book a Demo
                </p>
              </div>
            )}
          ...
          <div>
            ...
            {mobileCompany && (
              <div className="mt-4 space-y-3 text-gray-700">
                ...
                <p onClick={() => navigate("/jobs")} className="cursor-pointer">
                  Jobs
                </p>
              </div>
            )}
